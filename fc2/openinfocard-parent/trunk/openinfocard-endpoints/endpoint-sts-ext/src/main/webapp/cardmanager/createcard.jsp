...
<%@page import="com.awl.rd.fc2.storage.FactoryCardStorage"%>
<%
...
PropertiesManager properties = PropertiesManager.getInstance();
	...
	CardStorage storage = FactoryCardStorage.getCardStorage(supportedClaimsImpl);
...
<head>
    <title>geopriv Card Creation</title>
...
%>
<p style="font-weight:bold">Create a card</p>
...
<%
		...
		for (int i=0; i<dbSupportedClaims.size(); i++) {
		 ...
		 if (claim.uri.indexOf('?') == -1) {
			 out.println("<input type=\"text\" name=\"" + key + "\" class=\"forminput\"/>");
		 } else {
			 out.println("This is a wildcard claim");
		 }
		 out.println("</td></tr>");
		}
%>
