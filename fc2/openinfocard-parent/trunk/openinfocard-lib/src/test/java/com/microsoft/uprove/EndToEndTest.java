...
//    		PresentationProof proof = PresentationProtocol.generatePresentationProof(ip, disclosed, message, keyAndToken, attributes);
//
...
//    		PresentationProtocol.verifyPresentationProof(ip, disclosed, message, token, proof);    
//        }
//        
//    }
//
...
//    	{
//            System.out.println("Hash = " + messageDigestAlg);
...
//                    
//                    Issuer issuer = new IssuerProtocolParameters( numberOfTokens, ikap, attributes, tokenInformation ).generate();
//
//                    byte[][] msg1 = issuer.generateFirstMessage();
//
//                    Prover prover = new ProverProtocolParameters(numberOfTokens, ip, attributes, tokenInformation, proverInformation).generate();
//
...
//                    {
//                    	int numToDisclose = 0;
//                        System.out.print("Disclosed list = ");
//                        for (int index = 0; index < numberOfAttribs; index++)
//                        {
...
//                        	PresentationProtocol.generatePresentationProof(ip, disclosed, message, upkt[i], attributes);
//
//                        // verify the presentation proof
//                        PresentationProtocol.verifyPresentationProof(ip, disclosed, message, upkt[i].getToken(), proof);
//
//                        //
//                        // negative cases
//                        //
...
//                            try { PresentationProtocol.verifyPresentationProof(ip2, disclosed, message, upkt[i].getToken(), proof); fail(); }
...
//                                disclosed2 = new int[] { };
//                            }
//                            try { PresentationProtocol.verifyPresentationProof(ip, disclosed2, message, upkt[i].getToken(), proof); fail(); }
//                            catch (InvalidProofException ipe) { }
//
//                            // modify message
//                            try { PresentationProtocol.verifyPresentationProof(ip, disclosed, "wrong message".getBytes(), upkt[i].getToken(), proof); fail(); }
//                            catch (InvalidProofException ipe) { }
//
//                            // modify token
//                            try { PresentationProtocol.verifyPresentationProof(ip, disclosed, message, upkt[(i+1)%numberOfTokens].getToken(), proof); fail(); }
//                            catch (InvalidProofException ipe) { }
//                            
//                            // modify proof
//                            proof.setA("wrong proof".getBytes());
//                            try { PresentationProtocol.verifyPresentationProof(ip, disclosed, message, upkt[i].getToken(), proof); fail(); }
//                            catch (InvalidProofException ipe) { }
//                        }
//                    }
//                }
