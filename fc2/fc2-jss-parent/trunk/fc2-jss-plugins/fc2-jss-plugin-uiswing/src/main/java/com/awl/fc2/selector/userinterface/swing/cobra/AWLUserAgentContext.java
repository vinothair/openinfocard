 ...
 */
public class AWLUserAgentContext implements UserAgentContext {
	private static final Logger logger = Logger.getLogger(AWLUserAgentContext.class.getName());
	...
	public HttpRequest createHttpRequest() {
		return new AWLHttpRequest(this, this.getProxy());
	}	
