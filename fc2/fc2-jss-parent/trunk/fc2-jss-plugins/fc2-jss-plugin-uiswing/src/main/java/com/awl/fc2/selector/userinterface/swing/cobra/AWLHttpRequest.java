...
* @author J. H. S.
*/
public class AWLHttpRequest implements HttpRequest {
	private static final Logger logger = Logger.getLogger(AWLHttpRequest.class.getName());
	...
	public AWLHttpRequest(UserAgentContext context, java.net.Proxy proxy) {
		super();
