...
final class ProtocolHelper {
    ...
    static GroupElement computeProduct(final GroupElement[] bases,
        ...
        assert bases.length == exponents.length;
    ...
    static ZqElement genChallenge(IssuerParametersInternal ip, UProveTokenInternal upti, byte[] a, byte[] m, int[] disclosed, ZqElement[] disclosedX) {
