...
public class TestVectorsTest extends TestCase {
    ...
    private IssuerParameters loadIssuerParameters() throws IOException {
    	...
    	ip.setParametersUID(TestUtils.hexToBytes(testVectors.getProperty("UIDp")));
    	
    	BigInteger p = new BigInteger(1, TestUtils.hexToBytes(testVectors.getProperty("p")));
    	BigInteger q = new BigInteger(1, TestUtils.hexToBytes(testVectors.getProperty("q")));
    	BigInteger g = new BigInteger(1, TestUtils.hexToBytes(testVectors.getProperty("g")));
    	...
    	byte[][] publicKey = new byte[][] {
    			TestUtils.hexToBytes(testVectors.getProperty("g0")),
    			TestUtils.hexToBytes(testVectors.getProperty("g1")),
    			TestUtils.hexToBytes(testVectors.getProperty("g2")),
    			TestUtils.hexToBytes(testVectors.getProperty("g3")),
    			TestUtils.hexToBytes(testVectors.getProperty("g4")),
    			TestUtils.hexToBytes(testVectors.getProperty("g5")),
    			TestUtils.hexToBytes(testVectors.getProperty("gt"))
    			};
    	...
    	byte[][] proverIssuanceValues = new byte[][] {
    			TestUtils.hexToBytes(testVectors.getProperty("z0")),
    			TestUtils.hexToBytes(testVectors.getProperty("z1")),
    			TestUtils.hexToBytes(testVectors.getProperty("z2")),
    			TestUtils.hexToBytes(testVectors.getProperty("z3")),
    			TestUtils.hexToBytes(testVectors.getProperty("z4")),
    			TestUtils.hexToBytes(testVectors.getProperty("z5")),
    			TestUtils.hexToBytes(testVectors.getProperty("zt"))
    			};
    	ip.setProverIssuanceValues(proverIssuanceValues);
    	
    	ip.setSpecification(TestUtils.hexToBytes(testVectors.getProperty("S")));
