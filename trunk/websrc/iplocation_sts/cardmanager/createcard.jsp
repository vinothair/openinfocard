...
<%@ page import="com.telekom.developer.iplocation.model.IPAddressLocation"%>
<%
...
<%@page import="org.xmldap.transport.HTTPTransport"%><html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>IPLocation Card Creation</title>
...
<%
		...
		for (int i=0; i<dbSupportedClaims.size(); i++) {
		 ...
		 out.println("<tr><td>" + displayTag + ":</td><td>");
		 out.println("The value of this claim will be determined dynamically when a token is requested");
		 out.println("</td></tr>");
		}
%>
...
<%
	    ...
	    for (int i=0; i<dbSupportedClaims.size(); i++) {
	    	DbSupportedClaim claim = (DbSupportedClaim)dbSupportedClaims.get(i);
	    	String key = claim.columnName;
	    	String value = ""; // should be set dynamically
